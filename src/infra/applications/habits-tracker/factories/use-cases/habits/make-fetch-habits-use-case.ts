import { FetchHabitsUseCase } from '@/domain/core-domains/habits-tracker/application/use-cases/habits-tracker-use-cases/habits/fetch-habit-use-case'
...
export function makeFetchHabitsUseCase() {
  ...
  const useCase = new FetchHabitsUseCase(habitsRepository)
