...
const config = {
  ...
  "inlineSchemaHash": "16f7746bdea9d2dcd51805ef232c11dde29af2bd94adf4e72ff1fe8e903c35b4",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/generated/habits-tracker",
    "generated/habits-tracker",
  ]
...
path.join(process.cwd(), "prisma/generated/habits-tracker/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/habits-tracker/schema.prisma")
